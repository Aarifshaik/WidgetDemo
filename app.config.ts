  ...
  widgets: [
    {
      ...
      previewImage: './assets/images/wid-pre.png', // Path to widget preview image
...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...config,
  name: 'WidgetDemo',
  slug: 'WidgetDemo', // Ensure slug is always defined
//   packageName: 'com.aarif1419.widgetdemo', // Add this line
  android: {
    package: 'com.aarif1419.widgetdemo', // Add this line
  },
